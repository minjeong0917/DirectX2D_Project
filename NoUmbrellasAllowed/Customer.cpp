...
ACustomer::ACustomer()
{
    ...
    CreateAnimation(RightEyeRenderer, "004", "004_neutral_loop.png", 3.1f, { 0,1,2, 3 ,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(RightEyeRenderer, "005", "005_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(RightEyeRenderer, "006", "006_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(RightEyeRenderer, "007", "007_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    ...
    CreateAnimation(LeftEyeRenderer, "004", "004_neutral_loop.png", 3.1f, { 0,1,2, 3 ,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(LeftEyeRenderer, "005", "005_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(LeftEyeRenderer, "006", "006_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
    CreateAnimation(LeftEyeRenderer, "007", "007_neutral_loop.png", 3.1f, { 0,1,2, 3,4 }, { 0.1f,0.1f,0.1f, 0.1f,4.0f });
...
void ACustomer::RandomCustomer(int _Gender, int _HairRand, int _Head, int _Body, int _Eyes, int _EyeBrow, int _Nose, int _Mouse)
{
    ...
    MouseRenderer->SetSprite("Mouse", _Mouse);
